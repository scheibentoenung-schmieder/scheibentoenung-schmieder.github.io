...
const premium = [
    {
        ...
        technicalDescription: [
            ...
            'Dicke ohne Liner 0,046mm',
            'Garantie 12 Jahre',
            'tiefschwarze Tönung (dunkelste Tönungsstufe), annähernd blickdicht von außen',
            'Splitterschutz',
            'Blendschutz',
...
function FolienSelectionComponent_ng_template_16_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "router-outlet");
} }
function FolienSelectionComponent_ng_template_20_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "router-outlet");
} }
