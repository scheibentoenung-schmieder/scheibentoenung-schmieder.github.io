...
function ContactComponent_ng_template_9_mat_optgroup_23_mat_option_1_Template(rf, ctx) { if (rf & 1) {
...
function ContactComponent_ng_template_9_mat_optgroup_23_Template(rf, ctx) { if (rf & 1) {
...
function ContactComponent_ng_template_9_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ContactComponent_ng_template_9_Template_button_click_28_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r9); const ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r8.send(); });
...
class ContactComponent {
    ...
    send() {
        emailjs_com__WEBPACK_IMPORTED_MODULE_2___default.a
            .send('gernsdorferlo_gmail_com', 'template_4W0j2trH', this.form.getRawValue(), 'user_u6oZ75mkiljk3Stt9fuiB')
            .then((response) => {
            this.form.reset();
            this.success = true;
        }, (err) => (this.error = err));
...
ContactComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ContactComponent, selectors: [["scheibentoenung-schmieder-contact"]], decls: 11, vars: 3, consts: [[1, "card"], ["class", "message-error", 4, "ngIf"], ["class", "message-success", 4, "ngIf", "ngIfElse"], ["showForm", ""], [1, "message-error"], [1, "message-success"], [1, "form", 3, "formGroup"], [1, "field"], ["matInput", "", "type", "text", "formControlName", "name", "placeholder", "Name"], ["matInput", "", "type", "text", "formControlName", "mail", "placeholder", "Email"], ["matInput", "", "type", "text", "formControlName", "phone", "placeholder", "Telefon"], ["matInput", "", "type", "text", "formControlName", "car", "placeholder", "Fahrzeug"], ["formControlName", "foil"], [3, "label", 4, "ngFor", "ngForOf"], ["rows", "5", "matInput", "", "formControlName", "message", "placeholder", "ihre Nachricht"], ["type", "submit", "color", "primary", "mat-raised-button", "", 1, "button-submit", 3, "disabled", "click"], [3, "label"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"]], template: function ContactComponent_Template(rf, ctx) { if (rf & 1) {
