...
FolienSelectionComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: FolienSelectionComponent, selectors: [["scheibentoenung-schmieder-folien"]], decls: 11, vars: 4, consts: [[1, "list"], ["mat-tab-nav-bar", ""], ["mat-tab-link", "", "routerLink", "/folien/regular", 3, "active"], ["mat-tab-link", "", "routerLink", "/folien/premium", 3, "active"], ["mat-tab-link", "", "routerLink", "/folien/superior", 3, "active"], ["mat-tab-link", "", "routerLink", "/folien/special", 3, "active"]], template: function FolienSelectionComponent_Template(rf, ctx) { if (rf & 1) {
